...
import { Plus, Clock, CheckCircle, AlertCircle, X, Loader2, ShieldCheck, Send, ArrowRight } from 'lucide-react';
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right flex flex-col items-end">
                    ...
                    <button 
                      ...
                      className="mt-4 text-primary-600 text-sm font-bold hover:text-primary-800 transition-colors flex items-center"
                    >
